    ...
    services = {
      ...
      postgresql = {
        ...
        ensureUsers =
          ...
          # the grafana system user; no password is involved. Gated because
          # an unused role would be stranded state on a host without grafana.
          ++ lib.optional config.services.grafana.enable {name = "grafana";};
      };
